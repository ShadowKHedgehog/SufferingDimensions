...
export const normalTimeStudies = [
  ...
  },
  {
    ...
    requirement: [32],
    reqType: TS_REQUIREMENT_TYPE.AT_LEAST_ONE,
    description: () => `Antimatter Galaxy requirement increases by ${formatInt(72)}
      8th Dimensions instead of ${formatInt(80)}`,
    effect: 72
  },
  {
    id: 51,
    ...
    requirement: [41, 42],
    reqType: TS_REQUIREMENT_TYPE.AT_LEAST_ONE,
    description: () => `You gain ${formatX(1e5)} more Infinity Points`,
    effect: 1e5
  },
  {
    id: 61,
  ...
  },
  {
    ...
    requirement: [71],
    reqType: TS_REQUIREMENT_TYPE.AT_LEAST_ONE,
    description: () => `Base Dimension Boost power becomes ${formatX(5)}`,
    effect: 5
  },
  {
    id: 82,
  ...
  },
  {
    ...
    description: () => (Achievement(103).canBeApplied
      ? `Make the Infinity Point formula better log(x)/${formatFloat(307.8, 1)} ➜ log(x)/${formatInt(307.9)}`
      : `Make the Infinity Point formula better log(x)/${formatInt(308)} ➜ log(x)/${formatInt(307.9)}`),
    effect: 307.9
  },
  {
    id: 121,
  ...
  },
  {
    ...
    requirement: [151],
    reqType: TS_REQUIREMENT_TYPE.AT_LEAST_ONE,
    description: () => `${formatX(1e17)} multiplier on all Infinity Dimensions`,
    effect: 1e7
  },
  {
    id: 171,
    ...
    description: () => `Time Shard requirement for the next Tickspeed upgrade goes up slower
      ${formatX(1.33, 0, 2)} ➜ ${formatX(1.31, 0, 2)}`,
    effect: () => 1.31
  },
  {
    id: 181,
    ...
    reqType: TS_REQUIREMENT_TYPE.ALL,
    description: () => `You gain ${formatPercents(0.001)} of your Infinity Points gained on crunch each second`,
    effect: () => gainedInfinityPoints().times(Time.deltaTime.div(1000))
  ...
  {
    id: 193,
    cost: new Decimal(1955),
    requirement: [181, () => EternityChallenge(10).completions > 0],
    reqType: TS_REQUIREMENT_TYPE.ALL,
    description: "Antimatter Dimension multiplier based on Eternities",
    effect: () => (DC.E616.pow(Currency.eternities.value.div(1e6).clampMax(1))),
    cap: DC.E616,
    formatEffect: value => formatX(value, 2, 1)
  },
  {
    ...
    requirement: [192],
    reqType: TS_REQUIREMENT_TYPE.AT_LEAST_ONE,
    description: "GET DILATION YOU MOTHER-"
  },
  {
    id: 211,
    cost: new Decimal(2130),
    requirement: [191],
    reqType: TS_REQUIREMENT_TYPE.AT_LEAST_ONE,
    description: () => `Dimension Boost requirement scaling is reduced by ${formatInt(2)}`,
    effect: 2
  },
  {
    id: 212,
  ...
  {
    id: 213,
    cost: new Decimal(2310),
    requirement: [193],
    reqType: TS_REQUIREMENT_TYPE.AT_LEAST_ONE,
    description: () => `You gain Replicanti ${formatInt(5)} times Slower`,
    effect: -5
  },
  {
    id: 214,

...
export const perks = {
  ...
  glyphslotextra1: {
    ...
    family: PERK_FAMILY.ACHIEVEMENT,
    get description() {
      return `You gain another glyph slot`;
    },
    effect: 1,
    automatorPoints: 50,
    shortDescription: () => "+1 Glyph Slot",
    // Adjusted position values to be closer to the other achievement perks
    layoutPosList: [13353, 81802, 81803, 79004, 79806, 84239],
  },
};
...
export const perkConnections = (function() {
  ...
  const groups = [
    ...
    [p.achievementGroup5, p.glyphslotextra1],
  ];
  const connections = {};
